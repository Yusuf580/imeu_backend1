...
export interface ApiAboutusAboutus extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    theme: Schema.Attribute.Component<'aboutus.theme', false>;
...
export interface ApiApplicationProcessApplicationProcess
  extends Struct.SingleTypeSchema {
  collectionName: 'application_processes';
  info: {
    displayName: 'ApplicationProcess';
    pluralName: 'application-processes';
    singularName: 'application-process';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contact: Schema.Attribute.Component<'common.contact', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String & Schema.Attribute.Required;
    form_btn: Schema.Attribute.String;
    form_description: Schema.Attribute.String;
    form_title: Schema.Attribute.String;
    frequent_questions: Schema.Attribute.Component<'application.asked', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    office: Schema.Attribute.Component<'contact.offices', false>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    follow_title: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer.footer'
...
export interface ApiFundingFunding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    apply: Schema.Attribute.Component<'funding.apply', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    mechanisms: Schema.Attribute.Component<'funding.mechanisms', false> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    section_description: Schema.Attribute.String & Schema.Attribute.Required;
    section1_title: Schema.Attribute.String & Schema.Attribute.Required;
    subsection1_description: Schema.Attribute.String &
      Schema.Attribute.Required;
    subsection1_heading: Schema.Attribute.String & Schema.Attribute.Required;
    subsection1_title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    button_apply: Schema.Attribute.String & Schema.Attribute.Required;
    button_apply_link: Schema.Attribute.String;
    button_fund: Schema.Attribute.String;
    button_fund_link: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feature_cards: Schema.Attribute.Component<'homepage.feature-card', true>;
    ...
    leftside_descrip: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    map_icon: Schema.Attribute.String & Schema.Attribute.Required;
    map_title: Schema.Attribute.String & Schema.Attribute.Required;
    mapcard: Schema.Attribute.Component<'homepage.map-card', true>;
    phase_btn: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rightside_descrip: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    nav_items: Schema.Attribute.Component<'navigation.nav-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteIdentitySiteIdentity extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    stickyLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiThemeSettingThemeSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    btn_accent: Schema.Attribute.String;
    btn_primary: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    text_color_normal: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::application-process.application-process': ApiApplicationProcessApplicationProcess;
